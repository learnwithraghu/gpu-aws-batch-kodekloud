#!/usr/bin/env python3
"""Run a disposable GPU AWS Batch smoke test and remove its resources."""
...
def main():
    ...
    parser.add_argument("--instance-type", default="g4dn.xlarge",
                        help="GPU instance type (default: g4dn.xlarge)")
    ...
    try:
        print(f"Creating GPU compute environment: {environment_name}")
